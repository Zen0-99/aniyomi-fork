...
class PackageInstallerInstallerNovel(private val service: Service) : InstallerNovel(service) {
...
private const val INSTALL_ACTION = "PackageInstallerInstallerNovel.INSTALL_ACTION"
