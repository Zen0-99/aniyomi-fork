...
import eu.kanade.presentation.browse.novel.MigrateNovelSearchScreen
...
class MigrateNovelSearchScreen(private val novelId: Long) : Screen() {
    ...
    override fun Content() {
        ...
        MigrateNovelSearchScreen(
            state = state,
            fromSourceId = dialogState.novel?.source,
            ...
            onClickSource = {
                navigator.push(
                    NovelSourceSearchScreen(dialogState.novel!!, it.id, state.searchQuery),
                )
            },
            onClickItem = {
