...
class NovelDownloadHeaderHolder(view: View, adapter: FlexibleAdapter<*>) : ExpandableViewHolder(
    view,
    adapter,
) {
    ...
    fun bind(item: NovelDownloadHeaderItem) {
    ...
    override fun onItemReleased(position: Int) {
        ...
        mAdapter.expandAll()
        (mAdapter as NovelDownloadAdapter).downloadItemListener.onItemReleased(position)
    }
}
