...
fun BaseNovelSourceItem(
    ...
    icon: @Composable RowScope.(NovelSource) -> Unit = defaultIcon,
    action: @Composable RowScope.(NovelSource) -> Unit = {},
    content: @Composable RowScope.(NovelSource, String?) -> Unit = defaultContent,
) {
...
private val defaultIcon: @Composable RowScope.(NovelSource) -> Unit = { source ->
    NovelSourceIcon(source = source)
}

private val defaultContent: @Composable RowScope.(NovelSource, String?) -> Unit = { source, sourceLangString ->
    Column(
        modifier = Modifier
